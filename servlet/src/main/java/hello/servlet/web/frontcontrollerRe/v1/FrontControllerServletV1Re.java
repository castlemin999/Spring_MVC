...
public class FrontControllerServletV1Re extends HttpServlet {
    Map<String, ControllerV1Re> controllerV1ReMap = new HashMap<>();

    public FrontControllerServletV1Re() {
        controllerV1ReMap.put("/front-controller-re/v1/members/new-form", new MemberFormControllerV1Re());
        controllerV1ReMap.put("/front-controller-re/v1/members/save", new MemberSaveControllerV1Re());
        controllerV1ReMap.put("/front-controller-re/v1/members", new MemberListControllerV1Re());
    }

    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String requestURI = request.getRequestURI();
        ControllerV1Re controller = controllerV1ReMap.get(requestURI);
